...
public class HttpDetailsWindow extends Window {
	...
	public HttpDetailsWindow(MethodCall m) {
		VerticalLayout l = new VerticalLayout();
		l.setSpacing(true);

		setCaption("Detalhes da Execução - HTTP");
		setContent(l);
		center();
		...
		TextArea typeData = new TextArea("HTTP");
		typeData.setWordwrap(true);
		typeData.setValue(m.getTypeData());
		typeData.setWidth("40em");
		fields.addComponent(typeData);			
